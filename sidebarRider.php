...
<aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-nav">
        <li>
            <a href="riderpage.php"><i class="fa fa-home"></i>Dashboard</a>
        </li> 
         <li>
            <a href="delivery.php"><i class="fa fa-cutlery"></i>Deliveries</a>
        </li>
        <li>
            <a href="chatRider.php"><i class="fa fa-comments"></i>Chat</a>
        </li>
        <li>
            <a href="completeTransaction.php"><i class="fa fa-history"></i>Transaction</a>
        </li>
        <li>
