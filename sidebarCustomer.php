        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="#" class="navbar-brand" id="sidebar-toggle"><i class="fa fa-bars" aria-hidden="true"></i></a>
                 <a href="#" class="navbar-brand" id="notif"><i class="fa fa-bell" onclick="shownotif()"><span class="notifbell" id="notif_number"></span></i></a>
            </div>
        </div>
    </nav>
    <div class="notifdetails" style="display: none;">
        <div class="notifClose">
            <span class="notifx" onclick="closeNotif()">&times;</span>   
        </div>
        ...
        ?>
        <span id="titleNotif">Notifications</span><br>
                    <div id="detailesNotif"></div>
                    <form action="deleteNotif.php" method="post" id="formDelete">
                        <input type="hidden" name="customer_Id" id="customer_value" value ="<?php echo $customer_Id;?>">
                        <button type="button" class="deletenotifBtn" onclick="deleteNotification()">Clear Notification</button>
                </form>
